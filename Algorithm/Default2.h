...
//   constexpr normal_iterator() noexcept : _current(Iter()) {}

//   explicit normal_iterator(const Iter& it) noexcept
//       : _current(i) t{}

//         // Forward iterator requirements
//         &
//         (Iter*)operator*() const noexcept {
//     return *_current;
//   }
...
//   constexpr iterator() noexcept : _current(Iter()) {}
//   explicit iterator(const(T*) & it) noexcept : _current(i) t {}
...
class Vector {
 public:
  ...
  pointer begin() { return _ptr; }
  const_pointer begin() const { return _ptr; }
  pointer end() { return _ptr + _size; }
  const_pointer end() const { return _ptr + _size; }
  const_pointer cbegin() const { return _ptr; }
  const_pointer cend() const { return _ptr + _size; }
